  ...
  const reverseGeocode = async (
    ...
    try {
      ...
      return {
        ...
        locationName: 'Manado', // Default fallback
        sublocality: '',
        postalCode: '',
        latitude: latitude,
        longitude: longitude,
    ...
    return new Promise(async resolve => {
      ...
      Geolocation.getCurrentPosition(
        position => {
          ...
          reverseGeocode(latitude, longitude).then(resolve);
        },
        error => {
  ...
  const takePhoto = useCallback(async () => {
    try {
      ...
      const options = {
        ...
        maxWidth: 2000,
        quality: 0.8,
        saveToPhotos: false, // Changed to false to prevent potential issues
        ...
        try {
          ...
          if (response.assets && response.assets[0]) {
            ...
            if (asset.uri) {
              ...
              setTanggal(dateStr);
              setWaktu(timeStr);
              console.log('Date and time set:', dateStr, timeStr);

              // Get location data - do this in background to prevent blocking UI
              ...
              try {
                ...
                console.error(
                  'Error getting location after photo:',
                  locationError,
                );
